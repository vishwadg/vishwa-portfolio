...
const About = () => {
  ...
  const skills = ['Java', 'Kotlin', 'JavaScript (ES6+)', 'Python', 'TypeScript', 'React', 'Angular', 'Spring', 'Hibernate', 'Node', 'AWS'];
    ...
    <StyledAboutSection id="about" ref={revealContainer}>
      ...
      <div className="inner">
        <StyledText>
          <div>
            <p>
            Hello! My name is Vishwa and I use my programming skills to solve real world problem. 
            </p>

            <p>
            I am experienced and adept software developer with over 7 years of proficiency in software design, development, 
            ...
            <p>
              ...
              <a href="https://www.7-eleven.com/">an American convenience store chain</a>,{' '}
              <a href="https://www.zakipointhealth.com/">an American HealthCare IT Company</a>,{' '}
              <a href="https://javra.com/">an Europian Software Company</a>,
